...
export default (editor, opts = {}) => {
  ...
  ${opts.label}
    ...
    <h1>Title</h1>
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla suscipit odio eu maximus finibus. Quisque nec
        felis ligula. Quisque quis augue vel ipsum convallis egestas.</p>
